...
# 2. تصميم الواجهة الاحترافية (خلفية سوداء مستوحاة من الشموع اليابانية ورسوم التداول)
st.markdown("""
    ...
    * { font-family: 'Cairo', sans-serif !important; direction: rtl !important; text-align: right !important; }
    ...
    /* العناوين الرئيسية */
    .main-title {
        color: #F0B90B; /* لون ذهبي يشبه منصات التداول */
    ...
    /* تعديل عناصر المدخلات لتناسب الثيم الداكن */
...
# 4. مؤشر الجاهزية النفسية بأزرار خيارات مريحة للجوال بدلاً من السواحب
...
# 5. حاسبة حجم العقد (Lot Size) المرنة - تم إصلاح مشكلة الأسهم للجوال بإضافة خطوة التغيير (step)
...
if st.button("💾 حفظ وتدوين الصفقة في سجل النظام"):
    # إذا كانت الصفقة خاسرة والسبب ليس الالتزام، يسجل كمبلغ مفقود (نزيف سلوكي)
...
if not st.session_state.trade_journal.empty:
    ...
    # رسم بياني للنتائج والنزيف السلوكي يتوافق مع الخلفية الداكنة لشاشات التداول
